...
<body>
    <div class="container">
        ...
        <div class="middle-part">
            ...
            <a href="../mainpages/admin.php" class="Navbtn" id="courses-btn">دوراتنا</a>
            <a href="../components/Montada.php" class="Navbtn" id="contact-us-btn">المنتدى</a>
        </div>
        <!--Navigation Bar right side-->
        <div class="right-side">
            <div class="LOG">
                <a href="../components/Admin-Dashboard.php" class="Navbtn" id="Acc"></i>ادارة الموقع </a>
            </div>
        <!-- On media right side-->
            <div class="drop-down">
    ...
    <div class="media-drop-down-btns">
        <a href="../components/Teacher-Dashboard.php" class="on-media-btns" dir="rtl">&nbsp;&nbsp;ادارة الموقع <i class="fas fa-sign-in-alt"></i></a>
        <a href="../mainpages/admin.php" class="on-media-btns">دوراتنا</a>
