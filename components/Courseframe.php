...
<nav>
        <div class="container">
            ...
            <div class="middle-part">
                <a href="about-us.php" class="Navbtn" id="about-us-btn">من نحن ؟</a>
                <a href="../guest.php #courses " class="Navbtn" id="courses-btn">دوراتنا</a>
                <a href="Montada.php" class="Navbtn" id="contact-us-btn">المنتدى</a>
            </div>
            <!--Navigation Bar right side-->
            <div class="right-side">
                <div class="LOG">
                    <a href="SignIn.php" class="Navbtn" id="LogInNavbtn"> <i
                            class="fa-solid fa-arrow-right-to-bracket"></i>تسجيل الدخول</a>
                    <a href="SignUP.php" class="Navbtn" id="SignInNavbtn"><i
        ...
        <div class="media-drop-down-btns">
            <a href="SignIn.php" class="on-media-btns" dir="rtl">&nbsp;&nbsp;تسجيل الدخول<i
                    class="fas fa-sign-in-alt"></i></a>
            <a href="SignUP.php" class="on-media-btns" dir="rtl">&nbsp;&nbsp; انشئ حسابك الآن <i
                    class="fa-solid fa-user"></i></a>
            <a href="../guest.php #courses" class="on-media-btns">دوراتنا</a>
            <a href="about-us.php" class="on-media-btns">من نحن ؟</a>
            <a href="Montada.php" class="on-media-btns">المنتدى</a>
        </div>
        </div>
    </nav>
